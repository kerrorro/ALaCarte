...
var bottomContainer = Container.template($ => ({     left: 0, right: 0, top: 250, bottom: 0,     skin: $.skin, contents: [
    new Label({ left: 15, top: 0, bottom: 0, height:0, string: "Subtotal",style: titleStyle}),
  	new Label({ left: 15, top: 45, bottom: 0, height:0, string: "Tax",style: titleStyle}),
  	new Label({ left: 15, top: 90, bottom: 0, height:0, string: "Total",style: titleStyle}),
