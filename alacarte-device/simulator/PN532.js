...
var TOKENS = [  {uid: "banana", pages: []},
                {uid: "chocolate chip cookies", pages: []},
                {uid: "whole wheat bread", pages: []},
                {uid: "ground beef", pages: []},
                {uid: "apple", pages: []},]
...
var TokensList = Column.template(function($) { return {
	left:0, right:0,
	contents: [
		Label($, { left:0, right:0, top:0, height:30, style:THEME.labeledButtonStyle, string:"Placed Food" }),
        NFCTokenButton({ data:$, string:"[ ] (WTFen)", value: undefined }, {  })
	],
}});
